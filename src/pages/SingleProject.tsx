...
export const SingleProject = () => {
  ...
  const { isLoading, isFetching, isError, error, data } = singleProjectQuery;
    ...
    <>
      {
        isError && (
          <div className="w-full flex justify-center">
            <AlertMessage className="my-8 w-2/4" status="error" message={getErrorMessage(error)} title="" />
          </div>
        )
      }
      {
        data &&
        <div id="project-container" className="flex w-full flex-row justify-between p-10">
